...
## Overview
My first ever web project where I learned the basics of HTML and CSS. A simple landing page for a sailing club.

## What I Learned
- 🎯 HTML structure and semantics
- 🎨 CSS styling and layouts
- 📐 Basic web page composition
...
**Note:** This project represents where my journey started. Everyone begins somewhere! 🚀
